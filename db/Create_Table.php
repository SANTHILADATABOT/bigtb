...
class PM_Create_Table {
    ...
    public function __construct() {
        ...
        $this->update_version();
        $this->task_types();
        $this->create_report_data_table();
        $this->create_column_datatypes_table();
    }
    ...
    public function create_report_data_table()
    {
        global $wpdb;
        $table_name = $this->prefix() . 'pm_report_data';
    ...
    public function create_column_datatypes_table()
    {
        global $wpdb;
        $table_name = $this->prefix() . 'pm_column_datatypes';

        $sql = "CREATE TABLE IF NOT EXISTS {$table_name} (
                `id` int(6) NOT NULL AUTO_INCREMENT,
                `column_name` tinytext NOT NULL,
                `datatype` tinytext NOT NULL,
                `column_order` int(6) NOT NULL,
