...
export default {
  ...
  computed: {
    menu() {
      ...
      if ( typeof project.meta === 'undefined' ) return [];
      ...
      let items = pm_apply_filters(
        ...
        [
          ...
          { // Materials
            route: { name: 'project_materials', project_id: this.project_id },
            name: 'Materials',
            count: 1,
            class: 'materials pm-sm-col-12',
            order: 5
          },
          { // Files
      ...
      // anything after 7th index will be moved to moreMenu
