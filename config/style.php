...
return [
    ...
    'pm-primeicons' => [
        'id'         => 'pm-primeicons',
        'url'        => plugin_dir_url( dirname( __FILE__ ) ) . 'views/assets/css/primevue/primeicons.css',
        'dependency' => false,
        'path'       => $view_path . '/assets/css/primevue/primeicons.css',
    ],
    'pm-primevue' => [
        'id'         => 'pm-primevue',
        'url'        => plugin_dir_url( dirname( __FILE__ ) ) . 'views/assets/css/primevue/primevue.css',
        'dependency' => false,
        'path'       => $view_path . '/assets/css/primevue/primevue.css',
    ],
    'pm-primevue-theme' => [
        'id'         => 'pm-primevue-theme',
        'url'        => plugin_dir_url( dirname( __FILE__ ) ) . 'views/assets/css/primevue/themes/bootstrap4-light-blue/theme.css',
        'dependency' => false,
        'path'       => $view_path . '/assets/css/primevue/themes/bootstrap4-light-blue/theme.css',
    ],
    'pm-element-ui' => [
        'id'         => 'pm-element-ui',
        'url'        => plugin_dir_url( dirname( __FILE__ ) ) . 'views/assets/css/element-ui/theme-chalk/index.css',
        'dependency' => false,
        'path'       => $view_path . '/assets/css/element-ui/theme-chalk/index.css',
    ],
    'pm-bootstrap' => [
        'id'         => 'pm-bootstrap',
        'url'        => plugin_dir_url( dirname( __FILE__ ) ) . 'views/assets/css/bootstrap/bootstrap.css',
        'dependency' => false,
        'path'       => $view_path . '/assets/css/bootstrap/bootstrap.css',
    ],
    'pm-nprogress' => [
        'id'         => 'pm-nprogress',
